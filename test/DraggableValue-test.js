...
var DraggableValue = require('../src/DraggableValue');

describe('DraggableValue component', function() {

	var props;
	var value;
	var dndContext;
	var DecoratedValue = Dnd.DragDropContext(HTML5Backend)(DraggableValue);
	var Value = Dnd.DragDropContext(HTML5Backend)(DraggableValue);
	...
	before(function() {
		...
		TestUtils.renderIntoDocument(<Dnd.DragDropContextProvider backend={HTML5Backend}><Value {...props}>{OPTION.label}</Value></Dnd.DragDropContextProvider>);
	});
