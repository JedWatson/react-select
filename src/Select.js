...
var Select = React.createClass({
	...
	propTypes: {
		...
		inputTooShortText: React.PropTypes.string, // label when there is no input
	...
	getDefaultProps: function() {
		return {
			...
			inputTooShortText: 'Type to search',
			name: undefined,
			onChange: undefined,
			className: undefined,
			matchPos: 'any',
	...
	buildMenu: function() {
		...
		return ops.length ? ops : 
				<div className="Select-noresults">
					{this.state.inputValue ? this.props.noResultsText : this.props.inputTooShortText}
				</div>;
