...
var Select = React.createClass({
	...
	buildMenu: function() {
		...
		var ops = _.map(this.state.filteredOptions, function(op) {
			...
			return <div key={'option-' + op.value} className={optionClass} onMouseEnter={mouseEnter} onMouseLeave={mouseLeave} onMouseDown={mouseDown} onClick={mouseDown}>{op.label}</div>;
