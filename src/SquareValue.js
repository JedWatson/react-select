...
class SquareValue extends Component {
  ...
  renderLabel () {
    ...
    return this.props.onClick || this.props.value.href ? (
      <a className={className} onDoubleClick={()=>{this.props.onClick(this.props.value)}} href={this.props.value.href} target={this.props.value.target} onMouseDown={this.handleMouseDown} onTouchEnd={this.handleMouseDown}>
        {this.props.children}
      </a>
    ) : (
