...
class ValueDrag extends Component{
constructor(props){
  super(props);
}
handleDrag(){
...
renderLabel () {
  ...
  return this.props.onClick || this.props.value.href ? (
    <a className={className} href={this.props.value.href} target={this.props.value.target} onMouseDown={this.handleMouseDown.bind(this)} onTouchEnd={this.handleMouseDown.bind(this)}>
      {this.props.children}
    </a>
  ) : (
    <span className={className} onClick={this.handleDrag.bind(this)} role="option" aria-selected="true" id={this.props.id}>
      {this.props.children}
    </span>
  );
}
...
export default ValueDrag;

// export default DragSource('valueDrag', knightSource, collect)(DragSource);
