	...
	render () {
		...
		return (
			<div className="section">
				...
				<Select ref="stateSelect" scrollToIndex={4} autofocus options={options} simpleValue clearable={this.state.clearable} name="selected-state" disabled={this.state.disabled} value={this.state.selectValue} onChange={this.updateValue} searchable={this.state.searchable} />
