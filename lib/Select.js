  ...
  _createClass(Select, [{
    ...
    value: function onMenuClose() {
      ...
      setTimeout(function () {
        ...
        _this2.onInputChange('', { action: 'menu-close' });
    ...
    value: function buildMenuOptions(props, selectValue) {
      ...
      var toOption = function toOption(option, id) {
        var isDisabled = _this4.isOptionDisabled(option, selectValue);
        var isSelected = _this4.isOptionSelected(option, selectValue);
        var label = _this4.getOptionLabel(option);
        var value = _this4.getOptionValue(option);

        if (_this4.shouldHideSelectedOptions() && isSelected || !_this4.filterOption({ label: label, value: value, data: option }, inputValue)) {
          return;
        }

        var onHover = isDisabled ? undefined : function () {
          return _this4.onOptionHover(option);
        };
      ...
      return options.reduce(function (acc, item, itemIndex) {
        if (item.options) {
          ...
          if (!_this4.hasGroups) _this4.hasGroups = true;
          ...
          if (children.length) {
            var groupId = _this4.getElementId('group') + '-' + itemIndex;
            acc.render.push({
              type: 'group',
              key: groupId,
              data: item,
    ...
    value: function renderMenu() {
      ...
      var render = function render(props) {
        ...
        props.innerRef = isFocused ? _this6.getFocusedOptionRef : undefined;
      ...
      var menuElement = _react2.default.createElement(
        ...
        function (_ref2) {
          ...
          return _react2.default.createElement(
            Menu,
            _extends({
              className: _this6.state.menuClassOpen ? 'menu-style menu-open' : 'menu-style menu-closed'
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  MenuList,
                  _extends({}, commonProps, {
                    innerRef: _this6.getMenuListRef,
                    isLoading: isLoading,
                    maxHeight: maxHeight
                  }),
                  menuUI
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.cacheComponents = function (components) {
    _this8.components = (0, _index3.defaultComponents)({ components: components });
  };
  ...
  this.setValue = function (newValue) {
    ...
    _this8.onInputChange('', { action: 'set-value' });
    if (closeMenuOnSelect) {
      _this8.inputIsHiddenAfterUpdate = !isMulti;
      _this8.onMenuClose();
    }
    // when the select value should change, we should reset focusedValue
    _this8.clearFocusValueOnUpdate = true;
    onChange(newValue, { action: action, option: option });
  };

  this.selectOption = function (newValue) {
    var _props15 = _this8.props,
        blurInputOnSelect = _props15.blurInputOnSelect,
        isMulti = _props15.isMulti;


    if (isMulti) {
      var _selectValue3 = _this8.state.selectValue;

      if (_this8.isOptionSelected(newValue, _selectValue3)) {
        var candidate = _this8.getOptionValue(newValue);
        _this8.setValue(_selectValue3.filter(function (i) {
          return _this8.getOptionValue(i) !== candidate;
        }), 'deselect-option', newValue);
        _this8.announceAriaLiveSelection({
          event: 'deselect-option',
          context: { value: _this8.getOptionLabel(newValue) }
        });
      } else {
        _this8.setValue([].concat(_toConsumableArray(_selectValue3), [newValue]), 'select-option', newValue);
        _this8.announceAriaLiveSelection({
          event: 'select-option',
          context: { value: _this8.getOptionLabel(newValue) }
        });
      ...
      _this8.setValue(newValue, 'select-option');
      _this8.announceAriaLiveSelection({
        event: 'select-option',
        context: { value: _this8.getOptionLabel(newValue) }
      });
  ...
  this.removeValue = function (removedValue) {
    var onChange = _this8.props.onChange;
    var selectValue = _this8.state.selectValue;

    var candidate = _this8.getOptionValue(removedValue);
    ...
    _this8.announceAriaLiveSelection({
      event: 'remove-value',
      context: {
        value: removedValue ? _this8.getOptionLabel(removedValue) : undefined
      }
    });
    _this8.focusInput();
  };
  ...
  this.popValue = function () {
    ...
    _this8.announceAriaLiveSelection({
      event: 'pop-value',
      context: {
        value: lastSelectedValue ? _this8.getOptionLabel(lastSelectedValue) : undefined
      }
    });
  ...
  this.getOptionLabel = function (data) {
    return _this8.props.getOptionLabel(data);
  };

  this.getOptionValue = function (data) {
    return _this8.props.getOptionValue(data);
  };

  this.getStyles = function (key, props) {
    var base = _styles.defaultStyles[key](props);
    base.boxSizing = 'border-box';
    var custom = _this8.props.styles[key];
    return custom ? custom(base, props) : base;
  };

  this.getElementId = function (element) {
    return _this8.instancePrefix + '-' + element;
  };

  this.getActiveDescendentId = function () {
    var menuIsOpen = _this8.props.menuIsOpen;
  ...
  this.onMenuMouseMove = function (event) {
    _this8.blockOptionHover = false;
  };

  this.onControlMouseDown = function (event) {
    var openMenuOnClick = _this8.props.openMenuOnClick;

    if (!_this8.state.isFocused) {
      if (openMenuOnClick) {
        _this8.openAfterFocus = true;
      }
      _this8.focusInput();
    } else if (!_this8.props.menuIsOpen) {
      _this8.openMenu('first');
    } else {
      _this8.onMenuClose();
    }
  ...
  this.onDropdownIndicatorMouseDown = function (event) {
    ...
    if (_this8.props.isDisabled) return;
    var _props17 = _this8.props,
  ...
  this.onScroll = function (event) {
    if (typeof _this8.props.closeMenuOnScroll === 'boolean') {
      if (event.target instanceof HTMLElement && (0, _utils.isDocumentElement)(event.target)) {
        _this8.props.onMenuClose();
      }
    } else if (typeof _this8.props.closeMenuOnScroll === 'function') {
      if (_this8.props.closeMenuOnScroll(event)) {
        _this8.props.onMenuClose();
      }
    }
  };
  ...
  this.onTouchStart = function (_ref5) {
    ...
    _this8.initialTouchX = touch.clientX;
    _this8.initialTouchY = touch.clientY;
    _this8.userIsDragging = false;
  };
  ...
  this.onTouchMove = function (_ref6) {
    ...
    var deltaX = Math.abs(touch.clientX - _this8.initialTouchX);
    var deltaY = Math.abs(touch.clientY - _this8.initialTouchY);
    var moveThreshold = 5;

    _this8.userIsDragging = deltaX > moveThreshold || deltaY > moveThreshold;
  };

  this.onTouchEnd = function (event) {
    if (_this8.userIsDragging) return;

    // type cast the EventTarget
    var target = event.target;

    // close the menu if the user taps outside
    if (_this8.controlRef && !_this8.controlRef.contains(target) && _this8.menuListRef && !_this8.menuListRef.contains(target)) {
      _this8.blurInput();
    }

    // reset move vars
    _this8.initialTouchX = 0;
    _this8.initialTouchY = 0;
  };

  this.onControlTouchEnd = function (event) {
    if (_this8.userIsDragging) return;

    _this8.onControlMouseDown(event);
  };

  this.onClearIndicatorTouchEnd = function (event) {
    if (_this8.userIsDragging) return;

    _this8.onClearIndicatorMouseDown(event);
  };

  this.onDropdownIndicatorTouchEnd = function (event) {
    if (_this8.userIsDragging) return;

    _this8.onDropdownIndicatorMouseDown(event);
  };

  this.handleInputChange = function (event) {
    var inputValue = event.currentTarget.value;
    _this8.inputIsHiddenAfterUpdate = false;
    _this8.onInputChange(inputValue, { action: 'input-change' });
    _this8.onMenuOpen();
  };

  this.onInputFocus = function (event) {
    var _props18 = _this8.props,
    ...
    _this8.inputIsHiddenAfterUpdate = false;
    _this8.announceAriaLiveContext({
      event: 'input',
      context: { isSearchable: isSearchable, isMulti: isMulti }
    });
    _this8.setState({
    ...
    if (_this8.openAfterFocus || _this8.props.openMenuOnFocus) {
      _this8.openMenu('first');
    }
    _this8.openAfterFocus = false;
  };
  ...
  this.onInputBlur = function (event) {
    ...
    _this8.onInputChange('', { action: 'input-blur' });
    _this8.onMenuClose();
    _this8.setState({
      focusedValue: null,
      isFocused: false
  ...
  this.onOptionHover = function (focusedOption) {
    if (_this8.blockOptionHover || _this8.state.focusedOption === focusedOption) {
      return;
    }
    _this8.setState({ focusedOption: focusedOption });
  };

  this.shouldHideSelectedOptions = function () {
    var _props19 = _this8.props,
  ...
  this.onKeyDown = function (event) {
    ...
    _this8.blockOptionHover = true;
    switch (event.key) {
      case 'ArrowLeft':
        if (!isMulti || inputValue) return;
        _this8.focusValue('previous');
        break;
      case 'ArrowRight':
        if (!isMulti || inputValue) return;
        _this8.focusValue('next');
        break;
      case 'Backspace':
        if (inputValue) return;
        if (focusedValue) {
          _this8.removeValue(focusedValue);
        } else {
      ...
      case 'Tab':
        ...
        openMenuOnFocus && _this8.isOptionSelected(focusedOption, selectValue)) {
          return;
        }
        _this8.selectOption(focusedOption);
        break;
      case 'Enter':
        if (menuIsOpen) {
          ...
          _this8.focusOption('first');
        }
        break;
      case 'Escape':
        if (menuIsOpen) {
          _this8.inputIsHiddenAfterUpdate = false;
          _this8.onInputChange('', { action: 'menu-close' });
          _this8.onMenuClose();
      ...
      case 'ArrowUp':
        if (menuIsOpen) {
          _this8.focusOption('up');
        } else {
          _this8.openMenu('last');
        }
        break;
      case 'ArrowDown':
        if (menuIsOpen) {
          _this8.focusOption('down');
        } else {
          _this8.openMenu('first');
        }
        break;
      case 'PageUp':
        ...
        _this8.focusOption('pageup');
        break;
      case 'PageDown':
        if (!menuIsOpen) return;
        _this8.focusOption('pagedown');
        break;
      case 'Home':
        if (!menuIsOpen) return;
        _this8.focusOption('first');
