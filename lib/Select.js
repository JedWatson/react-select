...
var Select = React.createClass({
	...
	propTypes: {
		...
		trimFilterValue: React.PropTypes.func, // method to filter filterValue
	...
	filterOptions: function filterOptions(options, values) {
		...
		if (this.props.filterOptions) {
			...
			var filterOption = function filterOption(op) {
				...
				if (this.props.trimFilterValue) {
					filterValue = this.props.trimFilterValue.call(this, filterValue)
				}
