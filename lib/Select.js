...
var Select = _react2.default.createClass({
	...
	findPropChild: function findPropChild(propType) {
		switch (propType) {
			case 'optionRenderer':
				return (Array.isArray(this.props.children) ? this.props.children : [this.props.children]).filter(Boolean).filter(function (child) {
	...
	render: function render() {
		...
		return _react2.default.createElement(
			...
			isOpen ? _react2.default.createElement(_Menu2.default, { menuContainerStyle: this.props.menuContainerStyle,
