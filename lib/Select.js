...
Select.propTypes = {
	...
	isSortable: _propTypes2.default.bool, // boolean to enable the select options if they could be draggable, defaults to boolean
	sortableHandler: _propTypes2.default.func // make options draggable
};
