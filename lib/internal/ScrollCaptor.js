...
var ScrollCaptor = function (_Component) {
  ...
  function ScrollCaptor() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ScrollCaptor.__proto__ || Object.getPrototypeOf(ScrollCaptor)).call.apply(_ref, [this].concat(args))), _this), _this.isBottom = false, _this.isTop = false, _this.previousScrollTop = 0, _this.cancelScroll = function (event) {
