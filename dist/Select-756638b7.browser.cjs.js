...
var index = require('./index-9f538e4b.browser.cjs.js');
  ...
  _createClass(Select, [{
    ...
    value: function onMenuOpen() {
      if (this.props.keepCursorAtEnd && !this.props.isMulti) {
        ...
        this.onInputChange((_this$props$value = this.props.value) === null || _this$props$value === void 0 ? void 0 : _this$props$value.label, {
          action: 'input-change'
        });
      }
