...
export default function Advanced() {
  return (
    <Fragment>
      ...
      Below is a simple example of how you can write your own custom filter functions to filter the options displayed in react-select. It takes your inputValue and does a case-sensitive test only against the beginning of the option label.
