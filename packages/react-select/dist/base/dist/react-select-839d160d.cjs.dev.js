...
var __chunk_2 = require('../../chunk-c67d1d4f.cjs.dev.js');
...
function (_Component) {
  ...
  function ScrollCaptor() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "reachedOffset", false);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleEventDelta", function (event, delta) {
      var _this$props = _this.props,
          ...
          _this$props$scrollOff = _this$props.scrollOffset,
          scrollOffset = _this$props$scrollOff === void 0 ? 0 : _this$props$scrollOff;
      ...
      var shouldCancelScroll = false; // reset bottom/top/offset flags
      ...
      if (availableScroll - scrollOffset > delta && _this.reachedOffset) {
        _this.reachedOffset = false;
      }

      if (scrollOffset && isDeltaPositive && delta > availableScroll - scrollOffset) {
        if (onBottomArrive && !_this.isBottom && !_this.reachedOffset) {
          onBottomArrive(event);
          _this.reachedOffset = true;
        }
      }

      if (isDeltaPositive && delta > availableScroll) {
        if (onBottomArrive && !_this.isBottom && !scrollOffset) {
          onBottomArrive(event);
        }
  ...
  _createClass(Select, [{
    ...
    value: function renderMenu() {
      ...
      var _this$props18 = this.props,
          ...
          onMenuScrollToBottomOffset = _this$props18.onMenuScrollToBottomOffset;
