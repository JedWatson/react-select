...
- Removed primitives, and normalise multi-value components to be in line with existing component customization patterns. [#2821](https://github.com/JedWatson/react-select/pull/2821)
...
- Customizable components are now passed `innerProps` for simpler implementation
- Cleaned up internal Components and made sure they can all be styled
- Implemented customizable filtering function with support for case and diacritics
